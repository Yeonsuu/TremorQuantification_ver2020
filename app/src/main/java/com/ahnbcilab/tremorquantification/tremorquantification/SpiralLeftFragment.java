...
public class SpiralLeftFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_spiral_left, container, false);
        ...
        mTabLayout = (TabLayout) view.findViewById(R.id.spiral_left_tab);
    ...
    public void setFrag(int i) {
        ...
        switch (i) {
            case 0:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag1);
                tran.commit();
                break;
            case 1:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag2);
                tran.commit();
                break;
            case 2:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag3);
                tran.commit();
                break;
            case 3:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag4);
                tran.commit();
                break;
            case 4:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag5);
                tran.commit();
                break;
            case 5:
                ...
                tran.replace(R.id.spiral_left_viewpager, frag6);
                tran.commit();
                break;
