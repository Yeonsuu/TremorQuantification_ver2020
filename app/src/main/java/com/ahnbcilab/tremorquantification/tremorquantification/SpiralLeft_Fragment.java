...
public class SpiralLeft_Fragment extends Fragment {
    ...
    Spiral_Both_Rectangle_Fragment frag3 ;
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, final Bundle savedInstanceState) {
        ...
        // 초기 화면
        view = inflater.inflate(R.layout.fragment_spiralleft, container, false);
